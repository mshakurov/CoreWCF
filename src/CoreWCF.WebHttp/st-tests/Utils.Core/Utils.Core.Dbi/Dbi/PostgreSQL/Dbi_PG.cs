...
namespace ST.Utils
{
  ...
  public sealed partial class Dbi_PG : IDbi, IConnectionHolder_PG
  {
    ...
    private const string DEBUG_LOG_DBI_MESSAGE = "{0} - {1}";//"\"{0}\" - stored procedure \"{1}\"";
    #endregion
    ...
    #region MesureAndLog
    private static void MesureAndLog( Action act, string actionLogText )
    {
#if DEBUG_LOG_DBI_PG
      Exec.Mesure(
        act, ( elapsed, started ) => WriteToLog( string.Format( "Executed '{0}' in {1} (started: {2:HH:mm:ss.fff dd.MM.yyyy})", actionLogText, elapsed, started ), EventLogEntryType.Information )
      );
#else
      act();
#endif
    ...
    private static TResult MesureAndLog<TResult>( Func<TResult> act, string actionLogText )
    {
#if DEBUG_LOG_DBI_PG
      return Exec.Mesure(
        act, ( elapsed, started, _ ) => WriteToLog( string.Format( "Executed '{0}' in {1} (started: {2:HH:mm:ss.fff dd.MM.yyyy})", actionLogText, elapsed, started ), EventLogEntryType.Information )
      );
#else
      return act();
#endif
    ...
    public sealed class RSResult : IRSResult, IConnectionHolder_PG
    {
        ...
        where T : class, new()
      {
        ...
        }, String.Format( DEBUG_LOG_DBI_MESSAGE, "Dbi_PG.RS.List", name ) );
      }
      #endregion
        ...
        where T : class, new()
      {
        ...
        }, String.Format( DEBUG_LOG_DBI_MESSAGE, "Dbi_PG.RS.ListPartial", name ) );
      }
      #endregion
      ...
      public List<T> ListScalar<T>( string name, params object[] args )
      {
        ...
        }, String.Format( DEBUG_LOG_DBI_MESSAGE, "Dbi_PG.RS.ListScalar", name ) );
      }
      #endregion
        ...
        where T : class, new()
      {
        ...
        }, String.Format( DEBUG_LOG_DBI_MESSAGE, "Dbi_PG.RS.Single", name ) );
      }
      #endregion
        ...
        where T : class, new()
      {
        ...
        }, String.Format( DEBUG_LOG_DBI_MESSAGE, "Dbi_PG.RS.SinglePartial", name ) );
      }
      #endregion
    ...
    public sealed class XmlResult : IXmlResult, IConnectionHolder_PG
    {
        ...
        where T : class, new()
      {
        ...
        }, String.Format( DEBUG_LOG_DBI_MESSAGE, "Dbi_PG.Xml.List", name ) );
      }
      #endregion
        ...
        where T : class, new()
      {
        ...
        }, String.Format( DEBUG_LOG_DBI_MESSAGE, "Dbi_PG.Xml.Single", name ) );
      }
      #endregion
